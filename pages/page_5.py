...
from config import create_histogram_subplots
...
if mostrar_original:
    cols = ["impacto_en_bibliotecas_open", "impacto_en_bibliotecas_libre", "impacto_en_bibliotecas_politica"]
...
if mostrar_filtrado:
    cols = ["impacto_en_bibliotecas_datos_personales", "impacto_en_bibliotecas_privacidad", "impacto_en_bibliotecas:derechosautor"]
    titles = ["Protección de Datos Personales", "Privacidad de la Información", "Derechos de Autor"]
    create_histogram_subplots(df, cols, titles)